...
nmcli con add type ethernet ifname enp1s0f0 con-name WAN
nmcli con mod WAN ipv4.addresses 10.48.183.138/30 ipv4.gateway 10.48.183.137 ipv4.dns "1.1.1.1,8.8.8.8" ipv4.method manual
nmcli con mod WAN connection.autoconnect yes
nmcli con up WAN

# Setup for LAN interface
nmcli con add type ethernet ifname enp1s0f1 con-name LAN
nmcli con mod LAN ipv4.addresses 10.0.254.254/24 ipv4.method manual
